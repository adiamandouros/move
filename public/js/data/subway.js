        ...
        directions: [
            {
                ...
                stops: [
                    ...
                    { name: 'Μοναστηράκι',      engName: 'Monastiraki',         positions: ['back', 'center'], transfers: [], note: 'Αλλαγές M3 → Δημοτικό θέατρο: κέντρο | Αλλαγή M3 → Αεροδρόμιο: κέντρο' },
                    { name: 'Ομόνοια',          engName: 'Omonia',              positions: ['center-back', 'center-front'], transfers: [], note: 'Αλλαγές M2 → Ανθούπολη: πίσω/μπροστά | Αλλαγή M2 → Ελληνικό: πίσω/μπροστά' },
            ...
            },
            {
                ...
                stops: [
                    ...
                    { name: 'Βικτώρια',         engName: 'Victoria',            positions: ['center'] },
                    { name: 'Ομόνοια',          engName: 'Omonia',              positions: ['center-back', 'center-front'], transfers: [], note: 'Αλλαγές M2 → Ανθούπολη: κέντρο | Αλλαγή M2 → Ελληνικό: κέντρο' },
                    { name: 'Μοναστηράκι',      engName: 'Monastiraki',         positions: ['center'], transfers: [], note: 'Αλλαγές M3 → Δημοτικό θέατρο: πίσω | Αλλαγή M3 → Αεροδρόμιο: πίσω' },
        ...
        directions: [
            {
                ...
                stops: [
                    ...
                    { name: 'Σύνταγμα',         engName: 'Syntagma',        positions: ['center-back'], transfers: [], note: 'Αλλαγές M3 → Δημοτικό θέατρο: μπροστά | Αλλαγή M3 → Αεροδρόμιο: πίσω' },
                    ...
                    { name: 'Αττική',           engName: 'Attiki',          positions: ['center-back'], transfers: [], note: 'Αλλαγές σε Μ1 → πίσω' },
            ...
            },
            {
                ...
                stops: [
                    ...
                    { name: 'Σεπόλια',          engName: 'Sepolia',         positions: ['center-front'] },
                    { name: 'Αττική',           engName: 'Attiki',          positions: ['center-front'], transfers: [], note: 'Αλλαγές σε Μ1 → μπροστά' },
                    ...
                    { name: 'Ομόνοια',          engName: 'Omonia',          positions: ['center-back', 'front'], transfers: [], note: 'Αλλαγές σε Μ1 → μπροστά' },
                    { name: 'Πανεπιστήμιο',     engName: 'Panepistimio',    positions: ['center-back', 'center-front'] },
                    { name: 'Σύνταγμα',         engName: 'Syntagma',        positions: ['center', 'center-front'], transfers: [], note: 'Αλλαγές M3 → Δημοτικό θέατρο: πίσω | Αλλαγή M3 → Αεροδρόμιο: μπροστά' },
        ...
        directions: [
            {
                ...
                stops: [
                    ...
                    { name: 'Σύνταγμα',             engName: 'Syntagma',                positions: ['back', 'front'], transfers: [], note: 'Αλλαγή M2 → Ανθούπολη: κέντρο | Αλλαγή M2 → Ελληνικό: μπροστά' },
                    { name: 'Μοναστηράκι',          engName: 'Monastiraki',             positions: ['center-back'],   transfers: [], note: 'Κόμβος αλλαγών M1/M2/M3' },
