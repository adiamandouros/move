        ...
        directions: [
            {
                ...
                stops: [
                    ...
                    { name: 'Άγιος Δημήτριος',  engName: 'Agios Dimitrios', positions: ['center-back', 'center-front'] , central: true},
                    ...
                    { name: 'Σύνταγμα',         engName: 'Syntagma',        positions: ['center'], transfers: [
            ...
            },
            {
                ...
                stops: [
                    ...
                    { name: 'Άγιος Δημήτριος',  engName: 'Agios Dimitrios', positions: ['center-front'] , central: true},
        ...
        directions: [
            {
                ...
                stops: [
                    ...
                    { name: 'Εθνική Άμυνα',         engName: 'Ethniki Amyna',           positions: ['center'], central: true },
